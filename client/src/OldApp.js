    ...
    this.utils.checkIfEmergencyMonitoredByBrowserAdmin(this.browserAdmin._id, this.state.monitoring_grid)
                .then(boolean_value => {
                    if(boolean_value){
                        ...
                        this.utils.setAgentsInFocus(this.state.agents_in_focus, item, this.state.laser_agents)
                                .then(result => {
                ...
                this.utils.getAdminEmergencyMonitored(this.browserAdmin._id, this.state.monitoring_grid)
                        .then(emergency_monitored => {
                            ...
                            if(responses && responses.length > 0){
                                responses.push({agent:message.message, user: emergency_monitored.emergency});
                            }
                            else{
                                responses = [{agent:message.message, user: emergency_monitored.emergency}];
                            }
